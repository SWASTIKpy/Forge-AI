...
export const BlueTitle = ({
  ...
  <span
    className={`bg-linear-to-br font-fira from-blue-300 via-blue-400 to-blue-600 bg-clip-text text-transparent ${className}`}
  >
    {children}
  </span>
);
...
export const SectionHeading = ({
  ...
  <h2 className="font-fira text-[clamp(2rem,4vw,3rem)] leading-[1.1] tracking-tight">
